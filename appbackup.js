// ==================== FIREBASE CONFIG ====================
// REPLACE THIS WITH YOUR FIREBASE CONFIG FROM firebase-setup.html
...
function renderAllCustomers() {
 ...
 <button onclick="editCustomer('${phone}')" style="padding: 6px 14px; font-size: 12px; font-weight: 500; border: none; border-radius: 6px; cursor: pointer; background: li...
 <button onclick="deleteCustomer('${phone}')" style="padding: 6px 14px; font-size: 12px; font-weight: 500; border: none; border-radius: 6px; cursor: pointer; background: ...
 </div>
 ` : ''}
 </div>
 </div>
