...
<div class="modal-overlay" id="addCategoryModal" onclick="closeAddCategoryModal()">
    <div class="modal modal-small" onclick="event.stopPropagation()">
        <div class="modal-header">
            <h3 class="modal-title" data-i18n="products.addCategory">Add New Category</h3>
        ...
        <div style="padding: 0 24px 24px;">
            ...
            <button class="btn btn-primary btn-block" onclick="saveNewCategory()">
                ...
                <span data-i18n="products.addCategory">Add Category</span>
            </button>
        </div>
    </div>
</div>
...
<div class="modal-overlay" id="editCategoryModal" onclick="closeEditCategoryModal()">
    <div class="modal modal-small" onclick="event.stopPropagation()">
        <div class="modal-header">
            <h3 class="modal-title" data-i18n="products.editCategory">Edit Category</h3>
        ...
        <div style="padding: 0 24px 24px;">
            ...
            <div class="form-group">
                ...
                <input class="form-input" id="editCategoryNewName" data-i18n-placeholder="products.enterNewName" placeholder="Enter new name" type="text">
            </div>
            <div class="cb-actions">
                <button class="btn btn-outline" onclick="closeEditCategoryModal()" data-i18n="common.cancel">Cancel</button>
            ...
            <div class="delete-section" id="editCategoryDeleteSection">
                <button class="btn btn-danger btn-block" id="deleteCategoryBtn" onclick="showDeleteCategoryConfirm()">
                    ...
                    <span data-i18n="products.deleteCategory">Delete Category</span>
                </button>
                <p class="delete-warning" id="deleteCategoryWarning" data-i18n="products.deleteCategoryWarning">This will remove all variants and inventory under this category.</p>
...
<div class="modal-overlay" id="deleteCategoryModal" onclick="closeDeleteCategoryModal()">
    <div class="modal modal-small" onclick="event.stopPropagation()">
        <div class="modal-header" style="background: linear-gradient(135deg, var(--danger), #dc2626);">
            <h3 class="modal-title" style="color: white;" data-i18n="products.deleteCategory">Delete Category</h3>
        ...
        <div style="padding: 24px;">
            <div class="delete-confirm-box">
                ...
                <p><span data-i18n="products.aboutToDelete">You are about to delete</span> <strong id="deleteCategoryName"></strong> <span data-i18n="products.andAllVariants">and all its variants</span>.</p>
            ...
            <div class="cb-actions" style="margin-top: 20px;">
                <button class="btn btn-outline" onclick="closeDeleteCategoryModal()" data-i18n="common.cancel">Cancel</button>
