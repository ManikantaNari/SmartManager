...
<div class="modal-overlay" id="addAdvanceModal" onclick="closeAddAdvanceModal()">
    <div class="modal modal-small" onclick="event.stopPropagation()">
        <div class="modal-header">
            <h3 class="modal-title">Add Advance</h3>
        ...
        <div style="padding: 0 24px 24px;">
            ...
            <div class="form-group">
                ...
                <input type="number" id="addAdvanceAmount" placeholder="Enter amount" class="form-input">
            </div>
            ...
            <div class="cb-actions">
                <button class="btn btn-outline" onclick="closeAddAdvanceModal()">Cancel</button>
                <button class="btn btn-primary" onclick="confirmAddAdvance()">Add Advance</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal-overlay" id="changeDateModal" onclick="closeChangeDateModal()">
    <div class="modal modal-small" onclick="event.stopPropagation()">
        <div class="modal-header">
            <h3 class="modal-title">Change Pickup Date</h3>
            <button class="modal-close" onclick="closeChangeDateModal()">&times;</button>
        </div>

        <div style="padding: 0 24px 24px;">
            <div class="form-group">
                <label class="form-label">New Pickup Date <span class="required">*</span></label>
                <input type="date" id="changeDateInput" class="form-input">
            </div>

            <div class="cb-actions">
                <button class="btn btn-outline" onclick="closeChangeDateModal()">Cancel</button>
    ...
    <div class="modal modal-small" onclick="event.stopPropagation()">
        ...
        <div style="padding: 0 24px 24px;">
            ...
            <div class="balance-card success">
                <span class="balance-label">Balance to Collect</span>
            ...
            <div class="cb-actions">
                <button class="btn btn-outline" onclick="closeCompleteBookingModal()">Cancel</button>
        ...
        <div style="padding: 0 24px 24px;">
            <div class="cancel-warning-box">
                ...
                <div>
                    ...
                    <p class="warning-desc">This action cannot be undone. Inventory will be restored.</p>
                </div>
            </div>

            <div class="refund-card">
                <span class="refund-label">Advance to Refund</span>
                <span id="cancelRefundAmount" class="refund-amount">-</span>
            </div>

            <div class="cb-actions">
                <button class="btn btn-outline" onclick="closeCancelBookingModal()">Keep Booking</button>
...
<div class="modal-overlay" id="bookingReceiptModal" onclick="closeBookingReceipt()">
    <div class="modal modal-large" onclick="event.stopPropagation()">
        <div class="modal-header">
            ...
            <h3 class="modal-title" id="brTitle">Booking Receipt</h3>
        ...
        <div class="receipt-header" id="brHeader">
            ...
            <span id="brHeaderText">Payment Received</span>
        </div>
        ...
        <div style="padding: 0 24px 24px;">
            ...
            <div class="bd-section">
                ...
                <div class="bd-row">
                    <span class="bd-label">Transaction Date</span>
            ...
            <button class="btn btn-primary btn-block" style="margin-top: 12px;" onclick="closeBookingReceipt()">Done</button>
        </div>
    </div>
</div>
`;
